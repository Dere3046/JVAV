...
func main(): int { return 0; }
    ...
    test_header("integration_version_jvlc");
    {
        ...
        TEST_ASSERT(out.find("jvlc 0.3.3") != string::npos, "jvlc version string");
    ...
    test_header("integration_version_jvavc");
    {
        ...
        string out;
        TEST_ASSERT(read_output("version.out", out), "read version output");
        TEST_ASSERT(out.find("jvavc 0.3.3") != string::npos, "jvavc version string");
        std::remove("version.out");
    }
    ...
    test_header("integration_version_jvm");
    {
        ...
        string out;
        TEST_ASSERT(read_output("version.out", out), "read version output");
        TEST_ASSERT(out.find("jvm 0.3.3") != string::npos, "jvm version string");
        std::remove("version.out");
    }
    ...
    test_header("integration_version_disasm");
    {
        ...
        string out;
        TEST_ASSERT(read_output("version.out", out), "read version output");
        TEST_ASSERT(out.find("disasm 0.3.3") != string::npos, "disasm version string");
        std::remove("version.out");
    }
